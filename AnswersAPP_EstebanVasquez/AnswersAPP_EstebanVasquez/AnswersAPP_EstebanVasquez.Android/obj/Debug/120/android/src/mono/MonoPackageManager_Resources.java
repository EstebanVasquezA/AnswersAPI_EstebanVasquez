...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AnswersAPP_EstebanVasquez.Android.dll" comes first in this list. */
		"AnswersAPP_EstebanVasquez.Android.dll",
		"AnswersAPP_EstebanVasquez.dll",
		"FormsViewGroup.dll",
